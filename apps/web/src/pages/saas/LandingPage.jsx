...
import { useRegisterStore, useCheckSlug } from '../../hooks'
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-[#0B1120] font-display text-slate-900 dark:text-slate-100">
            ...
            <header className="fixed top-0 inset-x-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md z-40 border-b border-slate-200 dark:border-slate-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xl font-extrabold tracking-tight">WA Market</span>
                    </div>
                ...
                <div className="relative pt-32 pb-20 sm:pt-40 sm:pb-24 lg:pb-32 overflow-hidden">
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <p className="max-w-2xl mx-auto text-xl text-slate-600 dark:text-slate-400 mb-10 leading-relaxed">
                            Buka toko online Anda sendiri hari ini. Otomatisasi pesanan, terima pembayaran, dan integrasi kurir pengiriman langsung ke WhatsApp pelanggan.
                        </p>
                ...
                <div id="fitur" className="py-24 bg-white dark:bg-[#0F172A]">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Fitur Lengkap untuk Bisnis Anda</h2>
                            <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">Dirancang khusus untuk mempermudah penjualan online, menghemat waktu kasir, dan memberikan kenyamanan pelanggan.</p>
                        </div>
                        
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <FeatureCard 
                                icon="chat" 
                                title="Notifikasi WAHA API" 
                                desc="Tagihan dan resi dikirim otomatis ke WhatsApp pelanggan tanpa perlu mengetik manual." 
                            />
                            <FeatureCard 
                                icon="storefront" 
                                title="Multi-Tenant SaaS" 
                                desc="Satu platform, ribuan toko. Setiap toko memiliki URL isolasi unik dan database tersendiri." 
                            />
                            <FeatureCard 
                                icon="two_wheeler" 
                                title="Manajemen Kurir" 
                                desc="Tugaskan armada pengantaran toko Anda sendiri dengan panel kurir khusus berdesain ringan." 
                            />
                            <FeatureCard 
                                icon="inventory" 
                                title="Katalog Produk" 
                                desc="Atur produk, varian, harga, dan stok barang secara real-time lalu pajang di storefront indah Anda." 
                            />
                            <FeatureCard 
                                icon="point_of_sale" 
                                title="Kasir Otomatis" 
                                desc="Sistem menghitung total ongkir dan keranjang otomatis sehingga meminimalisir salah hitung." 
                            />
                            <FeatureCard 
                                icon="insights" 
                                title="Statistik & Analitik" 
                                desc="Ketahui jumlah pengunjung, pesanan terbaik, dan total pendapatan langsung dari Dashboard Admin." 
                            />
                        </div>
                    </div>
                </div>
            ...
            <footer className="bg-slate-900 border-t border-slate-800 py-12 text-center text-slate-400">
                <div className="flex items-center justify-center gap-2 mb-4">
                    ...
                    <span className="text-xl font-bold text-white">WA Market</span>
                </div>
                <p>&copy; 2026 WA Market Platform. Built with Hono & React.</p>
            </footer>
